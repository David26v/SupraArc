    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <Badge
            variant="outline"
            className="border-blue-600 text-blue-600 mb-6"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Scalable online stores with payment integration and inventory management",
              image:
            ...
            },
            {
              ...
              description:
                "Secure, scalable cloud solutions optimized for performance",
              image:
            ...
            <Card
              key={index}
              className="group hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white"
            >
              ...
              <CardContent className="p-6">
                ...
                <Button
                  variant="ghost"
                  className="mt-4 group-hover:text-blue-600 transition-colors"
                >
